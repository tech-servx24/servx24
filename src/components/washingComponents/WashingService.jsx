...
import { faSprayCan, faCar, faMotorcycle } from '@fortawesome/free-solid-svg-icons';
  ...
  if (isVehicleModalOpen) {
    return (
      <VehicleTypeSelectorModal
        ...
        description="Choose your vehicle type to find washing & detailing centers"
        vehicleTypes={vehicleTypes}
        headerIcon={faSprayCan}
        headerTitle="Washing & Detailing"
        onBack={onBackToMain}
        footerText="Click on any vehicle type to find washing & detailing centers near you"
      />
    );
  }
